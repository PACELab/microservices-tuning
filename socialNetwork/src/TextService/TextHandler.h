...
//  queueContainer *textQC = new queueContainer(ipPrintWindowInMS,text_initObjID,text_numQueueObjs); // avs
//  proxyQueues *q_UploadText =  textQC->allQueueObjs[idx_text_UploadText];   // avs
