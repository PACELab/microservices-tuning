...
//  queueContainer *homeTimelineQC = new queueContainer(ipPrintWindowInMS,homeTimeline_initObjID,homeTimeline_numQueueObjs); // avs
//  proxyQueues *q_ReadHomeTimeline =  homeTimelineQC->allQueueObjs[idx_homeTline_ReadHomeTimeline];   // avs
};
...
//  q_ReadHomeTimeline->incrReqs(); //avs
  // Initialize a span
