...
//  queueContainer *uniqueIdQC = new queueContainer(ipPrintWindowInMS,uniqueId_initObjID,uniqueId_numQueueObjs); // avs
//  proxyQueues *q_UploadUniqueId =  uniqueIdQC->allQueueObjs[idx_uniqueId_UploadUniqueId];   // avs
//  //proxyQueues *q_HashMacAddressPid =  uniqueIdQC->allQueueObjs[idx_uniqueId_HashMacAddressPid];   // avs
//  //proxyQueues *q_GetMachineId =  uniqueIdQC->allQueueObjs[idx_uniqueId_GetMachineId];   // avs
