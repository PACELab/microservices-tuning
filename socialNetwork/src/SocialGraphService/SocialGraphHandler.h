...
//  queueContainer *socialGraphQC = new queueContainer(ipPrintWindowInMS,socialGraph_initObjID,socialGraph_numQueueObjs); // avs
//  proxyQueues *q_follow =  socialGraphQC->allQueueObjs[idx_socialGraph_follow];   // avs
//  proxyQueues *q_unfollow =  socialGraphQC->allQueueObjs[idx_socialGraph_unfollow];   // avs
//  proxyQueues *q_getFollowers =  socialGraphQC->allQueueObjs[idx_socialGraph_getFollowers];   // avs
//  proxyQueues *q_getFollowees =  socialGraphQC->allQueueObjs[idx_socialGraph_getFollowees];   // avs
//  proxyQueues *q_insertUser =  socialGraphQC->allQueueObjs[idx_socialGraph_insertUser];   // avs

//  proxyQueues *q_followWithUsername =  socialGraphQC->allQueueObjs[idx_socialGraph_followWithUsername];   // avs
//  proxyQueues *q_unfollowWithUsername =  socialGraphQC->allQueueObjs[idx_socialGraph_unfollowWithUsername];   // avs
...
//  q_followWithUsername->incrReqs(); //avs
  // Initialize a span
  TextMapReader reader(carrier);
  std::map<std::string, std::string> writer_text_map;
  TextMapWriter writer(writer_text_map);
...
//  q_unfollowWithUsername->incrReqs(); //avs
  // Initialize a span
  TextMapReader reader(carrier);
  std::map<std::string, std::string> writer_text_map;
  TextMapWriter writer(writer_text_map);
