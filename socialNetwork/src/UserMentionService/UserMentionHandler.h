...
//  queueContainer *userMentionQC = new queueContainer(ipPrintWindowInMS,userMention_initObjID,userMention_numQueueObjs); // avs
//  proxyQueues *q_userMention =  userMentionQC->allQueueObjs[idx_userMention_UploadUserMention];   // avs
