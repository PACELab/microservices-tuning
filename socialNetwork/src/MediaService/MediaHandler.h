...
//  queueContainer *mediaQC = new queueContainer(ipPrintWindowInMS,media_initObjID,media_numQueueObjs); // avs
//  proxyQueues *q_uploadMedia =  mediaQC->allQueueObjs[idx_media_UploadMedia];   // avs
