...
//  queueContainer *urlShortQC = new queueContainer(ipPrintWindowInMS,urlShort_initObjID,urlShort_numQueueObjs); // avs
//  proxyQueues *q_UploadUrl =  urlShortQC->allQueueObjs[idx_urlShort_UploadUrl];   // avs
