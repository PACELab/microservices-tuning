...
if __name__ == '__main__':
  ...
  parser.add_argument("-c", "--cast", action="store", dest="cast_filename",
    type=str, default="/home/ubuntu/uservices/DeathStarBench/mediaMicroservices/datasets/tmdb/casts.json")
  parser.add_argument("-m", "--movie", action="store", dest="movie_filename",
    type=str, default="/home/ubuntu/uservices/DeathStarBench/mediaMicroservices/datasets/tmdb/movies.json")
